...
@section('container')
    ...
    <form id="formCreate" action="/marketing/quotations/{{ $quotation->id }}" method="post" enctype="multipart/form-data">
        @method('put')
        @csrf
        @if ($category == 'Signage')
        ...
        <div class="flex justify-center pl-14 py-10 bg-stone-800">
            <div class="z-0 mb-8 bg-stone-700 p-4 border rounded-md">
                <div class="flex w-full justify-center">
                    <div class="flex items-center w-[950px] border-b py-2">
                        <div class="w-[700px] text-xl text-teal-50 px-2 font-bold">EDIT PENAWARAN NOMOR :
                    ...
                    <div class="w-[950px] h-[1345px] bg-white p-4 mt-1">
                        ...
                        <div class="h-[1100px]">
                            <div class="flex justify-center">
                                <div class="w-[725px] mt-2">
                                    <div class="flex">
                                        ...
                                        <label class="ml-1 text-sm text-slate-500">{{ $quotation->number }}</label>
                                    </div>
                                    <div class="flex">
                                    ...
                                    <div class="flex mt-4">
                                        <div>
                                            <label class="ml-1 text-sm text-black flex">Kepada Yth.</label>
                                    ...
                                    <div class="flex mt-2">
                                        <textarea id="createBodyTop" name="body_top" class="ml-1 w-[721px] outline-none text-sm">{{ $quotation->body_top }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <!-- table start -->
                                ...
                                @else
                                    ...
                                    @elseif ($category == 'Signage')
                                        ...
                                        @if ($dataDescription->type == 'Videotron')
                                            @include('quotations.vt-edit-table')
                                        @else
                                            @include('quotations.bb-edit-table')
                                        @endif
                                    @else
                                        @include('quotations.bb-edit-table')
                                    @endif
                            ...
                            <div>
                                <div class="flex justify-center">
                                    <div class="flex mt-2">
                                        <textarea id="createBodyEnd" name="body_end" class="ml-1 w-[721px] outline-none text-sm" rows="1">{{ $quotation->body_end }}</textarea>
                                    </div>
                                </div>
                                <div class="flex justify-center">
                                    <div class="w-[725px] mt-2">
        ...
        <div>
            <div class="flex px-2  border-b-2 border-white w-full">
                ...
                <div class="flex w-full justify-end">
                    <form action="/marketing/quotations/{{ $quotation->id }}/edit">
    ...
    <!-- Edit Quotation end -->
    <script src="/js/editquotation.js"></script>
    @if ($category == 'Service')
        <script src="/js/serviceedittable.js"></script>
    @endif

                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="border p-1 text-center">
                                                                ...
                                                                <div class="flex w-full justify-center items-center mt-4">
                                                                    @if ($product->order_type == 'sales' || $product->order_type == 'free')
                                                                        {{ QrCode::size(100)->generate('https://saranamediapersada.co.id/marketing/sales/' . $install_order->sale->id) }}
                                                                    @else
                                                                        {{ QrCode::size(100)->generate('https://saranamediapersada.co.id/media/locations/' . $product->location_id) }}
                                                                    @endif
                                                                </div>
                                                            </td>
                                                        </tr>

                                    ...
                                    <div class="flex justify-center">
                                        <div class="flex w-[725px]">
                                            ...
                                            <div class="flex ml-4 mt-2">
                                                {{ QrCode::size(100)->generate('http://saranamediapersada.co.id/quotation-revisions/preview/' . $category . '/' . Crypt::encrypt($quotation_revision->id)) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="flex">
                                                        <div>
                                                            ...
                                                            <span class="w-[100px] flex mt-[40px] ml-2">
                                                                {{ QrCode::size(100)->generate('https://saranamediapersada.co.id/marekting/quotations/preview/' . $quotation_revision->quotation->media_category->name . '/' . $product->id) }}
                                                            </span>
                                                        </div>
                                                        <span
